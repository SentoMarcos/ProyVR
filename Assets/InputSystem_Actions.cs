...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""XRHand"",
            ""id"": ""68f230b9-3c97-4652-97d8-cb1bd0b26862"",
            ""actions"": [
                {
                    ""name"": ""RightHandRotation"",
                    ""type"": ""Value"",
                    ""id"": ""051c3cea-151c-49e5-b136-e387dd2c02f5"",
                    ""expectedControlType"": ""Quaternion"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ...
                    ""type"": ""Value"",
                    ""id"": ""af414417-8caf-4c2d-9dc5-dede02646f3e"",
                    ""expectedControlType"": ""Quaternion"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""7ab72d00-88b0-4c26-859c-8f2023d30004"",
                ...
                {
                    ""name"": """",
                    ""id"": ""baa6bddc-8f3f-4dfb-80e4-23e9ba66ee35"",
    ...
    ""controlSchemes"": [
        ...
        // XRHand
        m_XRHand = asset.FindActionMap("XRHand", throwIfNotFound: true);
        m_XRHand_RightHandRotation = m_XRHand.FindAction("RightHandRotation", throwIfNotFound: true);
        m_XRHand_LeftHandRotation = m_XRHand.FindAction("LeftHandRotation", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_XRHand.enabled, "This will cause a leak and performance issues, InputSystem_Actions.XRHand.Disable() has not been called.");
    }
    ...
    // XRHand
    private readonly InputActionMap m_XRHand;
    private List<IXRHandActions> m_XRHandActionsCallbackInterfaces = new List<IXRHandActions>();
    private readonly InputAction m_XRHand_RightHandRotation;
    private readonly InputAction m_XRHand_LeftHandRotation;
    /// <summary>
    /// Provides access to input actions defined in input action map "XRHand".
    /// </summary>
    public struct XRHandActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRHandActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "XRHand/RightHandRotation".
        /// </summary>
        public InputAction @RightHandRotation => m_Wrapper.m_XRHand_RightHandRotation;
        /// <summary>
        /// Provides access to the underlying input action "XRHand/LeftHandRotation".
        /// </summary>
        public InputAction @LeftHandRotation => m_Wrapper.m_XRHand_LeftHandRotation;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_XRHand; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="XRHandActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(XRHandActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="XRHandActions" />
        public void AddCallbacks(IXRHandActions instance)
        {
            if (instance == null || m_Wrapper.m_XRHandActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_XRHandActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="XRHandActions" />
        private void UnregisterCallbacks(IXRHandActions instance)
        {
            @RightHandRotation.started -= instance.OnRightHandRotation;
            @RightHandRotation.performed -= instance.OnRightHandRotation;
            @RightHandRotation.canceled -= instance.OnRightHandRotation;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="XRHandActions.UnregisterCallbacks(IXRHandActions)" />.
        /// </summary>
        /// <seealso cref="XRHandActions.UnregisterCallbacks(IXRHandActions)" />
        public void RemoveCallbacks(IXRHandActions instance)
        {
            if (m_Wrapper.m_XRHandActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="XRHandActions.AddCallbacks(IXRHandActions)" />
        /// <seealso cref="XRHandActions.RemoveCallbacks(IXRHandActions)" />
        /// <seealso cref="XRHandActions.UnregisterCallbacks(IXRHandActions)" />
        public void SetCallbacks(IXRHandActions instance)
        {
            foreach (var item in m_Wrapper.m_XRHandActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_XRHandActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="XRHandActions" /> instance referencing this action map.
    /// </summary>
    public XRHandActions @XRHand => new XRHandActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "XRHand" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="XRHandActions.AddCallbacks(IXRHandActions)" />
    /// <seealso cref="XRHandActions.RemoveCallbacks(IXRHandActions)" />
    public interface IXRHandActions
    {
        /// <summary>
        /// Method invoked when associated input action "RightHandRotation" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
